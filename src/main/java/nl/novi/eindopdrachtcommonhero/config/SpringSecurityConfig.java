...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST, "/vacancies/offer").hasAnyRole("USER", "ADMIN")
                .antMatchers(HttpMethod.POST, "/vacancies/search").hasAnyRole("USER", "ADMIN")
                .antMatchers(HttpMethod.GET, "/vacancies").permitAll()
                .antMatchers(HttpMethod.GET, "/vacancies/**").permitAll()
                .antMatchers(HttpMethod.DELETE, "/vacancies/**").hasAnyRole("USER", "ADMIN")
